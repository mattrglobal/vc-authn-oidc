...
namespace VCAuthn.IdentityServer.Endpoints
{
    public class TokenEndpoint: IEndpointHandler
    {
        ...
        public TokenEndpoint(IClientSecretValidator clientValidator, ISessionStorageService sessionStore, ITokenIssuerService tokenIssuerService, ILogger logger)
        {
        ...
        public class TokenResult : IEndpointResult
        {
            ...
            {
                var claims = new List<Claim> { new Claim(IdentityConstants.PresentationRequestConfigIDParamName, _session.PresentationRecordId) };
